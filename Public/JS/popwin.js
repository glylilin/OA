...
showWin: function(width, height, title,message) {
        ...
        inntHtml += '</div>'
        inntHtml += '<div width="' + width + '" height="' + iframeHeight + '" ><font color="red" style="height:148px;display:block;line-height:148px;text-align:center;font-size:20px;">'+message+'</font></div>';
