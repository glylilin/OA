...
<td><div class="txtbox floatL" style="width:200px;"><input name="info[username]" type="text" class="input" size="5" value="<?php echo ($data["username"]); ?>"></div></td>
<th>微信名 </th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[weiname]" type="text" size="5" class="input" value="<?php echo ($data["weiname"]); ?>"></div></td>
<th>微信号 </th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[weino]" type="text" size="5" class="input" value="<?php echo ($data["weino"]); ?>"></div></td>
</tr>

<tr>
<th>电话号码 <span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input disabled  type="text" size="5" class="input" value="<?php echo ($data["phonenum"]); ?>"><input name="info[phonenum]" id="phonenum" type="hidden" size="5" class="input" value="<?php echo ($data["phonenum"]); ?>"></div></td>
<th>销售总额<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[saleprice]" id="saleprice" type="text" size="5" class="input" value="<?php echo ($data["saleprice"]); ?>"></div></td>
<th>收入<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[income]" id="income" type="text" size="5" class="input" value="<?php echo ($data["income"]); ?>"></div></td>
</tr>

<tr>
<th>提成<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[commission]" id="commission" type="text" size="5" class="input" value="<?php echo ($data["commission"]); ?>"></div></td>
<th>类型<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[ctype]" id="ctype" type="text" size="5" class="input" value="<?php echo ($data["ctype"]); ?>"></div></td>
<th>线下时间</th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[linetime]" type="text" size="5" class="input Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo ($data["linetime"]); ?>"></div></td>
</tr>

<tr>
<th>欠款</th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[arrears]" type="text" size="5" class="input" value="<?php echo ($data["arrears"]); ?>"></div></td>
<th>备注</th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[remarks]" type="text" size="5" class="input" value="<?php echo ($data["remarks"]); ?>"></div></td>
<th>指导老师</th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[zteacher]" type="text" size="5" class="input" value="<?php echo ($data["zteacher"]); ?>"></div></td>
</tr>

<tr>
<th>经手微信<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[dealno]" id='dealno' type="text" size="5" class="input" value="<?php echo ($data["dealno"]); ?>"></div></td>
<th>渠道</th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[channels]" type="text" size="5" class="input" value="<?php echo ($data["channels"]); ?>"></div></td>
<th>是否为学员</th>
<td><div class="floatL" style="width:205px;background:#fff;height:38px; border: medium none;font-size: 16px;line-height:38px;">
	<input name="info[is_student]" type="radio" value="1" <?php if($data['is_student'] == 1): ?>checked="checked"<?php endif; ?>>是</input>
	<input name="info[is_student]" type="radio" size="5"value="0" <?php if(!$data['is_student']): ?>checked="checked"<?php endif; ?>>否</input></div></td>
</tr>
...
<th>是否要书</th>
<td><div class="floatL" style="width:205px;background:#fff;height:38px; border: medium none;font-size: 16px;line-height:38px;">
	<input name="info[is_book]" type="radio" value="1" <?php if($data['is_book'] == 1): ?>checked="checked"<?php endif; ?>>是</input>
	<input name="info[is_book]" type="radio" size="5" value="0" <?php if(!$data['is_book']): ?>checked="checked"<?php endif; ?>>否</input></div></td>
<th>是否补余款</th>
<td><div class="floatL" style="width:205px;background:#fff;height:38px; border: medium none;font-size: 16px;line-height:38px;">
	<input name="info[is_balance]" type="radio" value="1" <?php if($data['is_balance'] == 1): ?>checked="checked"<?php endif; ?>>是</input>
	<input name="info[is_balance]" type="radio" size="5" value="0" <?php if(!$data['is_balance']): ?>checked="checked"<?php endif; ?>>否</input>
</div></td>
<th>支付方式<span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:200px;"><input name="info[paymethod]" id="paymethod" type="text" size="5" class="input" value="<?php echo ($data["paymethod"]); ?>">
	<input type="hidden" name="info[orderid]" value="<?php echo ($data["orderid"]); ?>">
	<input type="hidden" name="info[uid]" value="<?php echo ($data["uid"]); ?>">
</div></td>
</tr>
<tr>
<th >图片备注2</th>
<td colspan='5'><div class="floatL" style="width:96%;background:#fff;height:300px; border: medium none;position:relative;" id="remaimgs">
	<?php if(is_array($data["remarks2"])): foreach($data["remarks2"] as $key=>$i): ?><div class="portrait"><img src="./Public/<?php echo ($i); ?>"/><span class="imgclose">x</span><input type="hidden" name="info[remarks2][]" value="<?php echo ($i); ?>"></div><?php endforeach; endif; ?>
...
$('#subBtn').click(function(){
	...
	if(phonenum =='' || saleprice =='' ||income ==''||commission==''||ctype==''||dealno==''||paymethod==''){
